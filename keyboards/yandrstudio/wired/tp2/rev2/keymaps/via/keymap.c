...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                          KC_SPC,              KC_RALT, KC_RALT, KC_RGUI, MO(1),   KC_RCTL,        KC_P0,            KC_PDOT),
    [1] = LAYOUT(
        KC_TRNS,
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, HF_TOGG, AU_TOGG, HF_FDBK,   AU_NEXT, AU_PREV, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                 KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
