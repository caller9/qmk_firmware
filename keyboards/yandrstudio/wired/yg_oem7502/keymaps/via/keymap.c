...
/*
    ...
    K600, K601, K602,                               K608, K609, K610,       K612, K613, K614, K615  \
*/
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYOUT(
        ...
        KC_CAPS, KC_A,    KC_S,    KC_D,  KC_F,  KC_G, KC_H,   KC_J,    KC_K,      KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  KC_PGUP, KC_VOLU,
        KC_LSFT,          KC_Z,    KC_X,  KC_C,  KC_V, KC_B,   KC_N,    KC_M,      KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   KC_PGDN, KC_VOLD,
        KC_LCTL, KC_LGUI, KC_LALT,                                      KC_SPC,    KC_RALT, MO(1),            KC_LEFT, KC_DOWN, KC_RGHT, KC_MUTE),
    ...
    LAYOUT(
        ...
        KC_TRNS,          RGB_TOG, RGB_MOD, RGB_RMOD,RGB_VAI, RGB_VAD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
