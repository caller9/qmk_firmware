...
static void inline show_default_img(void) {
    ...
    my_image = qp_load_image_mem_force(gfx_colortest);
    if (my_image != NULL) {
...
void keyboard_post_init_kb(void) {
    ...
    lcd = qp_st7735_make_spi_device(80, 160, ST7735_CS_PIN, ST7735_DC_PIN, ST7735_RES_PIN, 8, 0);
#else
    lcd = qp_st7735s_make_spi_device(80, 160, ST7735_CS_PIN, ST7735_DC_PIN, ST7735_RES_PIN, 8, 0);
#endif
    qp_set_viewport_offsets(lcd, 24, 0);
