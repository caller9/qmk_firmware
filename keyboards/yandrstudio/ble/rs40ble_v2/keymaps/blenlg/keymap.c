...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYOUT(
        KC_ESC,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,  KC_Y,   KC_U,         KC_I, KC_O,    KC_P,   KC_BSPC,
                 ...
                 KC_LCTL,          KC_LGUI, KC_LALT, LT(1, KC_SPC),        LT(2, KC_SPC),      KC_SLSH, KC_SCLN,KC_QUES),
    LAYOUT(
    ...
    LAYOUT(
        KC_F1,   KC_F2,   KC_F3,  KC_F4,  KC_F5,  KC_F6,   KC_F7,   KC_F8,  KC_F9,  KC_F10, KC_F11, KC_F12,
                 KC_TRNS, KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS, BL_SW_0, BL_SW_1,BL_SW_2,USB_TOG,BAT_SHOW,
        ...
        case BAT_SHOW: {
            if (record->event.pressed) {
                ...
                if (bat_l_t <= 10) {
                    ...
                    rgb_matrix_adv_unblink_all_batlayer_but_one_layer((bat_l_t % 101) / 9 + 10);
