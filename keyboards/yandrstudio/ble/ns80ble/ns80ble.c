...
const rgblight_segment_t PROGMEM my_capslock_layer[] = RGBLIGHT_LAYER_SEGMENTS({6, 1, HSV_WHITE});  // 2
const rgblight_segment_t PROGMEM bat_10_layer[] = RGBLIGHT_LAYER_SEGMENTS({0, 1, HSV_RED});         // 3
const rgblight_segment_t PROGMEM bat_30_layer[] = RGBLIGHT_LAYER_SEGMENTS({0, 2, HSV_GREEN});       // 4
const rgblight_segment_t PROGMEM bat_60_layer[] = RGBLIGHT_LAYER_SEGMENTS({0, 3, HSV_GREEN});       // 5
const rgblight_segment_t PROGMEM bat_90_layer[] = RGBLIGHT_LAYER_SEGMENTS({0, 4, HSV_GREEN});       // 6

const rgblight_segment_t* const PROGMEM _rgb_layers[] = RGBLIGHT_LAYERS_LIST(bt_conn, bt_pair,
                                                                             my_capslock_layer,
                                                                             bat_10_layer, bat_30_layer, bat_60_layer, bat_90_layer);
