...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
...
#ifdef FACTORY_TEST
        KC_LCTL, KC_LGUI,KC_LALT,     FT_BT_1, FT_BT_2,     FT_BT_3,   KC_RALT, KC_RGUI, KC_SPC, KC_RCTL),
#else
        KC_LCTL, KC_LGUI,KC_LALT,     KC_SPC,  KC_SPC,      KC_SPC,    KC_RALT, MO(1),   MO(2), KC_RCTL),
#endif
    LAYOUT(
    ...
    LAYOUT(
        ...
        KC_TRNS, BL_SW_0, BL_SW_1, BL_SW_2, USB_TOG, BLE_OFF, KC_BTSH, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS,
        KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS, KC_TRNS,          KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
    LAYOUT(
        ...
        case KC_BTSH: {
            if (record->event.pressed) {
                ...
                if (bat_l_t <= 10) {
                    ...
                    rgblight_blink_layer_repeat(10, 1000, 1);
                } else if (bat_l_t <= 50) {
