...
void dance_tab_ble_on_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (keycode)
    {
        ...
        case BL_SW_3:
            ...
            bluetooth_switch_one_without_wl(keycode - BL_SW_0);
            ble_channle_update(true);
            break;
        case BLE_DEL:
            if (where_to_send() == OUTPUT_BLUETOOTH) {
...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_FN_ESB]      = ACTION_TAP_DANCE_FN_ADVANCED_BLE(ESB_SW,  dance_tab_ble_on_finished),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT(
        ...
        KC_TRNS, BL_SW_0, BL_SW_1, BL_SW_2, BL_SW_3, ESB_SW,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
